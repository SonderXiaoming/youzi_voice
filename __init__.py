...
speaker_dict = {
    ...
    "公主连结":
    ['菈比莉斯塔（Overload）', '铃奈（夏日）', '杏奈', '雪菲', '可可萝', '菈比莉斯塔', '绫音（圣诞节）', '碧（插班生）', '嘉夜', '镜华（万圣节）', 
    '珠希', '望（夏日）', '铃莓', '真琴（夏日）', '静流（情人节）', '咲恋', '莉玛', '香澄（夏日）', '千歌', '忍', '依里', '佩可莉姆（新年）', 
    '胡桃', '智（魔法少女）', '优衣', '怜（万圣节）', '栞', '香织（夏日）', '祈梨（时间旅行）', '咲恋（夏日）', '铃奈', '真步（夏日）', '亚里莎', 
    '镜华', '未奏希', '伊莉亚（圣诞节）', '美里', '似似花', '克莉丝提娜（圣诞节）', '美冬（夏日）', '莉玛（灰姑娘）', '铃莓（夏日）', '古蕾雅', 
    '美美（万圣节）', '千歌（圣诞节）', '碧', '雪', '惠理子（情人节）', '伊绪', '拉姆', '七七香（夏日）', '铃莓（新年）', '铃（游骑兵）', '环奈', 
    '惠理子', '可可萝（礼服）', '优衣（新年）', '望（圣诞节）', '可可萝（公主）', '纯（夏日）', '环奈（振袖）', '咲恋（圣诞节）', '露娜', '香澄（魔法少女）', 
    '姬塔', '矛依未（新年）', '栞（魔法少女）', '真步（灰姑娘）', '怜（新年）', '千歌（夏日）', '祈梨', '由加莉', '佩可莉姆（夏日）', '步美（仙境）', 
    '可可萝（夏日）', '绫音', '由加莉（圣诞节）', '真阳', '雷姆', '茜里', '铃', '凛（偶像大师）', '凯露', '克罗依（圣学祭）', '秋乃', '克莉丝提娜', 
    '佩可莉姆', '露', '莫妮卡', '璃乃', '静流（夏日）', '纺希（万圣节）', '香澄', '美咲', '美里（夏日）', '智', '初音', '璃乃（仙境）', '卯月（偶像大师）', 
    '空花', '珠希（夏日）', '纯', '美美', '忍（万圣节）', '妮侬（大江户）', '千爱瑠', '可可萝（新年）', '怜（公主）', '未奏希、美美、镜华', '伊莉亚', '望', 
    '优衣（公主）', '凯露（公主）', '克罗依', '秋乃（圣诞节）', '优衣（礼服）', '杏奈（夏日）', '静流', '未奏希（万圣节）', '茜里（天使）', '宫子', '日和莉（新年）', 
    '优妮', '安', '流夏（夏日）', '美冬（工作服）', '美冬', '初音（夏日）', '矛依未', '凯露（夏日）', '莫妮卡（魔法少女）', '香织', '宫子（万圣节）', '美咲（万圣节）', 
    '妮侬', '怜', '真阳（游骑兵）', '碧（工作服）', '日和莉', '七七香', '真琴', '步美', '深月', '日和莉（公主）', '伊绪（夏日）', '茉莉', '佩可莉姆（公主）', 
    '空花（大江户）', '惠理子（夏日）', '凯露（新年）', '爱蜜莉雅', '依里（天使）', '茉莉（万圣节）', '真琴（灰姑娘）', '纺希', '真步', '流夏', '似似花（新年）', 
    '未央（偶像大师）', '胡桃（圣诞节）', '千爱瑠（圣学祭）'],

    "魔法纪录":
    ['环彩羽(Tamaki Iroha)', '环忧(Tamaki Ui)', '七海八千代(Nanami Yachiyo)', '十咎桃子(Togame Momoko)', '水波玲奈(Minami Rena)', '秋野枫(Akino Kaede)', 
    '八云御魂(Yakumo Mitama)', '由比鹤乃(Yui Tsuruno)', '深月菲莉希亚(Mitsuki Felicia)', '二叶莎奈(Futaba Sana)', '梓美冬(Azusa Mifuyu)', 
    '佐仓杏子(Sakura Kyōko)', '天音月咲(Amane Tsukasa)', '天音月夜(Amane Tsukuyo)', '里见灯花(Satomi Tōka)', '柊音梦(Hiiragi Nemu)', '和泉十七夜(Izumi Kanagi)', 
    '阿莉娜·格雷(Alina Gray)', '蓝家姬奈(Aika Himena)', '大庭树里(Ōba：Juri)', '宫尾时雨', '丘比(QB)', '巴麻美(Tomoe Mami)']
